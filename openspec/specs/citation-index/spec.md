# citation-index Specification

## Purpose
The ft-core index from paragraph identity to citing synth notes:
build, three-state lookup semantics (cited / cited-stale / uncited),
and its integration points (CLI per-invocation build, TUI
GraphSnapshot). Created by archiving change citation-visibility.
